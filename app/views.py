...
def rating(request,id):
    ...
    return render(request, 'Vendor/rating.html', context)
...
def edit_agencyprofile(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'Vendor/agencyprofile.html', context)
...
def health_assistance(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'Vendor/health-assistant.html', context)
    else:
        health_assistants = HealthAssistant.objects.filter(user_id=user)
        context = {
            'health_assistants': health_assistants,
